...
export default function repair_shampoo_280mL() {
    return (
        <div className="">
            <Head>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-auto md:w-1/2">
                                <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/images/satinique-color-repair-shampoo-280mL.webp" alt="Body Wash" />
                            </div>
                            <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                <h3 className="uppercase text-lg font-semibold">Satinique Color Repair Shampoo - 280mL</h3>
                                <div className="mt-2">
