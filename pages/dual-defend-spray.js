...
const details = {
    ...
    price: "15.80",
    image: "/images/satinique-dual-defend-spray.webp"
}
                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-auto md:w-1/2">
                                <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/images/satinique-dual-defend-spray.webp" alt="Body Wash" />
                            </div>
                            <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                ...
                                <div className="mt-2">
                                    ...
                                    <div className="mt-1">
                                        ...
                                        <p>Shake well. Spray 8-12 inches from damp or dry hair. Leave in.</p>
