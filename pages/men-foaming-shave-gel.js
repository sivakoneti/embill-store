...
const details = {
    ...
    price: "11.50",
    image: "/images/G&H-soothe+-for-men-foaming-shave-gel.webp"
}
                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-auto md:w-1/2">
                                <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/images/G&H-soothe+-for-men-foaming-shave-gel.webp" alt="Body Wash" />
                            </div>
