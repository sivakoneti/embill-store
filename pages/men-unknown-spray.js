...
const details = {
    ...
    price: "63.00",
    image: "/images/artistry-men-unknown-spray.webp"
}
                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-auto md:w-1/2">
                                <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/images/artistry-men-unknown-spray.webp" alt="Body Wash" />
                            </div>
