                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-auto md:w-1/2">
                                <img className="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/images/artistry-signature-pencil-sharpener.webp" alt="Body Wash" />
                            </div>
                            <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                <h3 className="uppercase text-lg font-semibold">Artistry Signature Color Eye Pencil Sharpener</h3>
                                <div className="mt-2">
                                    <label className="text-2xl">Description</label>
                                    <div className="mt-1">
                                        <p className="text-lg mx-2">Keep your eye pencils sharp</p>
                                        <ul className="pl-5">
                                            <li className="list-disc">Helps create a precise line to define your perfect eye look.</li>
                                            <li className="list-disc">Conveniently sized to tuck into your makeup bag.</li>
                                        </ul>
